    ...
    <main className="min-h-screen flex flex-col items-center">
      <div className="flex-1 w-full flex flex-col gap-0 items-center">
        ...
        <div style={{ display: "flex", flexDirection: "row", alignItems: "center", gap: "2rem", width: "100%", justifyContent: "center" }}>
          <div style={{ width: 500, height: 228, overflow: "hidden", maxWidth: "100%" }}>
            <iframe
          ...
          <div>
            <p className="mb-6 text-lg font-normal text-gray-900 lg:text-xl sm:px-16 xl:px-48 dark:text-white">CE Liberation of Undermine US Rank 476</p>
            <p className="mb-6 text-lg font-normal text-gray-900 lg:text-xl sm:px-16 xl:px-48 dark:text-white">CE Nerubar Palace US Rank 606</p>
            <p className="mb-6 text-lg font-normal text-gray-900 lg:text-xl sm:px-16 xl:px-48 dark:text-white">7/9M Amirdrassil, the Dream's Hope</p>
            <p className="mb-6 text-lg font-normal text-gray-900 lg:text-xl sm:px-16 xl:px-48 dark:text-white">5/9M Aberrus, the Shadowed Crucible</p>
            <p className="mb-6 text-lg font-normal text-gray-900 lg:text-xl sm:px-16 xl:px-48 dark:text-white">5/8M Vault of the Incarnates</p>
          </div>
        </div>
        <Link
          href="/apply"
